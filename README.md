...
| 이름 | 학번 | 담당 기능 |
|------|------|----------|
| 김민수 | 2019113077 | 위험도 산출 프레임, 환자 관리 패널, 리마인더 기능 |
| 김민균 | 2023025693 | 메인프레임, 콘텐츠 추가/요청 기능, 코드 통합 |
| 조민지 | 2024005180 | 로그인프레임, 식단 추천 기능 |
| 정재욱 | 2024008493 | 가족/주치의 연결, 건강 데이터 분석, 알림/메시지, 친구 기능 |
