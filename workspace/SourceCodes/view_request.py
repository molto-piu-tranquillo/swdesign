        ...
        try:
            ...
            for user in userlist:
                ...
                if (user.getUserType() == '개인 사용자' or user.getUserType() == 'Patient') \
                   and hasattr(user, 'resetChangeRequestList'):
                    user.resetChangeRequestList() # 요청 삭제
    ...
    def load_all_requests(self):
        ...
        try:
            ...
            for user in userlist:
                ...
                if is_patient and hasattr(user, 'getChangeRequestList'):
                    requests = user.getChangeRequestList()
                    if requests:
                        has_request = True
